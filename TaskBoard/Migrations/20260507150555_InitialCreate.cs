        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskCards_BoardColumns_BoardColumnId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "İlk proje", "Demo Proje" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "$2a$11$79ndqr1FTZwUq7/.iXBbj.rzxMV9AmVKkyUq/1OD./zexYLTsHUxi", 1, "admin" },
                    { 2, "$2a$11$6NtFb0cHrHf54iEZ.hVbF.XRZMYU5rM7WIYegDqw6IB/ObWlEWBeq", 0, "kullanici1" }
                });

            migrationBuilder.InsertData(
                table: "BoardColumns",
                columns: new[] { "Id", "Name", "OrderIndex", "ProjectId" },
                values: new object[,]
                {
                    { 1, "Yapılacak", 0, 1 },
                    { 2, "Yapılıyor", 1, 1 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskCards_BoardColumnId",
                table: "TaskCards",
